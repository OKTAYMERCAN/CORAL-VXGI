...
PROGRAMS = {
    ...
    # SIRA ÖNEMLİ: Iris geçişleri numara sırasıyla çalıştırır.
    # Gürültü giderme, aydınlatma birleştirmesinden ÖNCE bitmelidir.
    "deferred2":             ("denoise_seed",     [],                      "330 compatibility"),
    "deferred3":             ("denoise1",         [],                      "330 compatibility"),
    "deferred4":             ("denoise2",         [],                      "330 compatibility"),
    "deferred5":             ("denoise3",         [],                      "330 compatibility"),
    "deferred6":             ("lighting",         [],                      "330 compatibility"),
    "composite":             ("composite",        [],                      "330 compatibility"),
    # TAA, aydınlatma ve composite bittikten SONRA çözümlenir
    "composite1":            ("taa_resolve",      [],                      "330 compatibility"),
